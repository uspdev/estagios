...
<form method="POST" action="/empresas">
    ...
    <div class="form-group">
        ...
        <input type="text" maxlength="128" class="form-control" name="nome_da_empresa" value="{{old('nome_da_empresa')}}">
    </div>
    <div class="form-group">
        <label for="cnpj_da_empresa">CNPJ: <span title="Este campo é obrigatório.">*</span></label>
        <input type="text" maxlength="14" class="form-control" name="cnpj_da_empresa" value="{{old('cnpj_da_empresa')}}">
    </div>
    <div class="form-group">
        <label for="area_de_atuacao_da_empresa">Área de atuação da Empresa: <span title="Este campo é obrigatório.">*</span></label>
        <input type="text" maxlength="128" class="form-control" name="area_de_atuacao_da_empresa" value="{{old('area_de_atuacao_da_empresa')}}">
    </div>
    <div class="form-group">
        <label for="endereco_da_empresa">Endereço da Empresa: <span title="Este campo é obrigatório.">*</span></label>
        <input type="text" maxlength="128" class="form-control" name="endereco_da_empresa" value="{{old('endereco_da_empresa')}}">
    </div>    
    <div class="form-group">
        ...
        <input type="text" maxlength="128" class="form-control" name="nome_do_representante_da_empresa" value="{{old('nome_do_representante_da_empresa')}}">
    </div>    
    <div class="form-group">
        ...
        <input type="text" maxlength="128" class="form-control" name="cargo_do_representante_da_empresa" value="{{old('cargo_do_representante_da_empresa')}}">
    </div>
    <div class="form-group">
        ...
        <input type="text" maxlength="128" class="form-control" name="nome_do_supervisor_do_estagio" value="{{old('nome_do_supervisor_do_estagio')}}">
    </div>
    <div class="form-group">
        ...
        <input type="text" maxlength="128" class="form-control" name="cargo_do_supervisor_do_estagio" value="{{old('cargo_do_supervisor_do_estagio')}}">
    </div>
    <div class="form-group">
        ...
        <input type="text" maxlength="128" class="form-control" name="telefone_do_supervisor_do_estagio" value="{{old('telefone_do_supervisor_do_estagio')}}">
    </div>    
    <div class="form-group">
        <label for="email_do_supervisor_do_estagio">E-mail do Supervisor de Estágios: <span title="Este campo é obrigatório.">*</span></label>
        <input type="email" maxlength="128" class="form-control" name="email_do_supervisor_do_estagio" value="{{old('email_do_supervisor_do_estagio')}}">
    </div>
    <div class="form-group">
