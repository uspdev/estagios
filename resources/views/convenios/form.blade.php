  ...
  <div class="card-header"><h4>Funcionário para contato</h4></div>
    <div class="card-body">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="text" name="tel_contato" class="form-control" id="tel_contato"  maxlength="11" placeholder="Insira o telefone com DDD" value="{{old('tel_contato',$convenio->tel_contato)}}">
        </div>
      </div>
      <div class="form-group row">
